...
DROP TRIGGER IF EXISTS trigger_notify_creators_new_event ON public.events;
DROP TRIGGER IF EXISTS trigger_notify_client_application ON public.applications;
DROP TRIGGER IF EXISTS trigger_notify_creator_application_update ON public.applications;
DROP TRIGGER IF EXISTS trigger_notify_creator_request ON public.requests;
DROP TRIGGER IF EXISTS trigger_notify_request_status_update ON public.requests;
DROP TRIGGER IF EXISTS trigger_notify_booking_created ON public.bookings;

-- Drop existing functions if they exist
DROP FUNCTION IF EXISTS notify_creators_of_new_event();
DROP FUNCTION IF EXISTS notify_client_of_application();
DROP FUNCTION IF EXISTS notify_creator_of_application_update();
DROP FUNCTION IF EXISTS notify_creator_of_request();
DROP FUNCTION IF EXISTS notify_client_of_creator_request();
