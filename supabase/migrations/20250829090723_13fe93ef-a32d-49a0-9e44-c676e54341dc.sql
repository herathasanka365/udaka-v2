...
CREATE TYPE public.user_role AS ENUM ('client', 'creator');
CREATE TYPE public.event_status AS ENUM ('active', 'closed');
CREATE TYPE public.application_status AS ENUM ('pending', 'accepted', 'rejected');
CREATE TYPE public.notification_type AS ENUM ('new_event', 'application', 'accepted');
CREATE TYPE public.search_role AS ENUM ('client', 'creator');
