...
export default function CreatorHeader({ userId }: CreatorHeaderProps) {
        ...
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" className="relative h-10 w-10 rounded-full">
            <Avatar className="h-9 w-9">
              <AvatarImage src="" alt={creatorProfile?.name || profile?.display_name || 'User'} />
          ...
          <div className="flex items-center justify-start gap-2 p-2">
            ...
            <div className="flex flex-col space-y-1 leading-none">
              <p className="font-medium">
                {creatorProfile?.name || profile?.display_name || 'User'}
              </p>
          ...
          {creatorProfile && (
            <div className="px-2 py-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm">{creatorProfile.category}</span>
              </div>
              {creatorProfile.bio && (
